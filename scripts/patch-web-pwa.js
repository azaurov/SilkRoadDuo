...
//
// Expo SDK 56 generates index.html from its own template and doesn't honor
// a custom web/index.html. For iOS Safari "Add to Home Screen" PWA install we
// need:
...
// (/SilkRoadDuo/) and for a root-hosted custom domain (empty base URL).
